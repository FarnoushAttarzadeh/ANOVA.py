...
dff = pd.read_csv(r'C:\Users\Farnoush\Desktop\Data\LaCie\Maxes\Phies\Negrocreek\MaxP-2010-Negrocreek.csv')
...
plt.xlabel('Moving Average of Phi (°)')
plt.ylabel('Averaged Height (km)')
plt.title('Moving Averaged Height Vs.Moving averaged Phi')
plt.xlim(left=0)
plt.ylim(bottom=0)
...
#fig.savefig('{}/M-Average-P-Wilberforce-2010.png'.format(output_dir))
...
plt.xlabel('Moving StD of Phi (°)')
plt.ylabel('Averaged Height (km)')
plt.title(' Moving Averaged Height Vs.Moving Standard Deviation of Phi')
plt.xlim(left=0)
plt.ylim(bottom=0)
...
fig.savefig('{}/M-STD-P-Negrocreek-2010.png'.format(output_dir))
...
with open(r'C:\Users\Farnoush\Desktop\Data\LaCie\Maxes\Phies\STDs3.csv', 'a+',newline='' ) as f:
...
#Dff=Dff.drop('201012')
Dff.to_csv(r'C:\Users\Farnoush\Desktop\Data\LaCie\Maxes\Phies\STDstd1.csv',mode='a')
